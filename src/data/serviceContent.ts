...
export const SERVICE_CONTENT: Record<string, ServicePageContent> = {
  ...
  "automated-hiring": {
    ...
    number: "07",
    serviceLabel: "Automated Hiring System",
    title:
      "The system that finds the right candidates in your applicant pool without your team reading a single CV manually.",
    subtitle:
      "Hiring is one of the most time-intensive things a growing business does and most of that time is spent on administration that has nothing to do with finding the right person.",
    problem: {
      heading:
        "Your team is spending days on hiring administration that should take hours.",
      body: "Applications come in, someone reads every CV, sends responses, schedules calls, and updates a spreadsheet while every other responsibility piles up. Good candidates lose interest because the process is too slow.",
    },
    outcome: {
      heading:
        "A shortlist of qualified pre-screened candidates waiting for your team without your team doing the screening.",
      body: "The system reads every application, qualifies candidates against your criteria, runs initial screening calls, and builds your shortlist automatically. Your team gets involved when it actually matters.",
    },
    roiHeading:
      "Find out what your current hiring process is costing your business in staff time.",
    pricing: {
      heading: "Choose the plan that fits where your business is right now.",
      subtext:
        "Every plan includes application intake setup, CV screening logic, candidate communication build, full hosting, and ongoing maintenance. Screening calls are charged at R5 per minute and WhatsApp candidate messaging at R0.50 per conversation beyond your free allocation.",
      tiers: [
        {
          name: "Entry",
          setup: "R3,000 setup",
          monthly: "R600 / month",
          description:
            "For businesses that hire occasionally and need a system that handles initial screening and candidate communication without a dedicated HR function managing it.",
        },
        {
          name: "Standard",
          setup: "R5,500 setup",
          monthly: "R1,200 / month",
          description:
            "For growing businesses that hire regularly across multiple roles and need the system to manage higher application volumes and feed shortlisted candidates into a structured interview pipeline.",
        },
        {
          name: "Premium",
          setup: "R8,000 setup",
          ...
          description:
            "For businesses or recruitment agencies hiring at volume across multiple simultaneous roles who need detailed reporting on candidate pipeline, screening outcomes, and time-to-hire metrics.",
        },
      ],
    },
    afterCheckout: {
      heading:
        "Your hiring system is live and processing applications within two weeks.",
      body: "Portal access within 60 seconds of payment. Onboarding call within 24 hours where we establish your screening criteria and ideal candidate profile. You approve all candidate-facing messaging before the system sends anything on your behalf.",
      ctaLabel: "Get your system live within two weeks",
    },
    bottomCTA: {
      heading:
        "Your next hire should not cost your team two weeks of administrative work to find.",
      body: "The right candidate is probably already in your applicant pool. We find them faster than any manual process can.",
    },
    servicePage: "/services/automated-hiring",
    brochure: "/brochures/automated-hiring.pdf",
  },
  "virtual-photoshoot": {
    slug: "virtual-photoshoot",
    number: "08",
    serviceLabel: "Virtual Photoshoot",
    title:
      "Campaign-ready product photography without a studio, a model booking, or a photographer.",
    subtitle:
      "A professional studio shoot costs between R15,000 and R80,000 and takes weeks to book and produce. Virtual Photoshoot delivers the same quality of imagery in days, at a fraction of that cost, with unlimited creative direction.",
    problem: {
      heading:
        "Your products deserve better photography than your budget has allowed for.",
      body: "Most product-based businesses either spend too much on occasional studio shoots or settle for images that do not do the product justice. Neither option is sustainable when you need a constant supply of fresh campaign content.",
    },
    outcome: {
      heading:
        "A library of professional campaign images your team can use across ads, your website, and social media, produced on demand whenever you need them.",
      body: "Upload your product, define your brand aesthetic, and receive studio-quality lifestyle and product images that are indistinguishable from a real shoot. No scheduling, no travel, no weather delays, no model availability issues.",
    },
    roiHeading:
      "Find out what your current photography spend is costing you versus what this delivers.",
    pricing: {
      heading: "Choose the pack that fits your current content needs.",
      subtext:
        "Once-off packs are delivered within 5 business days. Monthly retainers run on a rolling basis with new images delivered each month. All images are commercially licensed and ready to use immediately.",
      tiers: [
        {
          name: "Starter Pack",
          setup: "R3,500 once-off",
          monthly: "10 final images",
          description:
            "For brands that need a fresh batch of campaign-ready images for an upcoming product launch or ad campaign.",
          allocation: "Across 2 scenes.",
        },
        {
          name: "Campaign Pack",
          setup: "R7,500 once-off",
          monthly: "25 final images",
          description:
            "For brands running paid traffic campaigns that need enough creative variety to test multiple hooks and formats simultaneously.",
          allocation: "Across 5 scenes.",
        },
        {
          name: "Monthly Retainer",
          setup: "R9,500 / month",
          monthly: "40 images / month",
          description:
            "For brands that need a consistent supply of fresh campaign imagery every month without the cost or logistics of recurring studio shoots.",
          allocation: "Ongoing campaigns.",
        },
      ],
    },
    afterCheckout: {
      heading: "Your first images are delivered within 2 business days.",
      body: "After payment or sample request we run a brief brand alignment call to understand your product, your aesthetic, your target audience, and the scenes you need.",
      ctaLabel: "Request a sample shoot",
    },
    bottomCTA: {
      heading: "Your products deserve photography that makes people stop scrolling.",
      body: "We can show you exactly what that looks like for your specific brand before you commit to anything.",
    },
    servicePage: "/services/virtual-photoshoot",
    brochure: "/brochures/virtual-photoshoot.pdf",
    sampleMode: true,
  },
};
