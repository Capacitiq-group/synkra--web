...
export const SERVICES: Record<string, ServiceData & { slug: string; short: string }> = {
  ...
  "virtual-photoshoot": {
    ...
    eyebrow: "Service · Virtual Photoshoot",
    title: "Studio-quality product photography, without the studio.",
    intro:
      "AI-generated lifestyle and product imagery that is indistinguishable from a traditional shoot, delivered in days at a fraction of the cost.",
    problem: {
      heading: "Your products deserve better photography than your budget has allowed for.",
      body: "Either you overspend on occasional studio shoots, or you settle for images that do not do your product justice. Neither is sustainable.",
    },
    features: [
      { title: "On-brand", body: "Trained on your packaging, palette, and aesthetic." },
      { title: "Fast turnaround", body: "First images delivered within 2 business days." },
      { title: "Commercially licensed", body: "Use across ads, web, and social with no restrictions." },
      { title: "Unlimited direction", body: "Test scenes, models, and styles without re-booking anything." },
    ],
    steps: [
      { title: "Brand intake", body: "We capture your product, aesthetic, and target scenes." },
      { title: "Sample", body: "We generate a sample batch for your approval." },
      { title: "Produce", body: "We deliver the full pack inside 5 business days." },
      { title: "Iterate", body: "Monthly retainer brands receive ongoing campaign drops." },
    ],
    outcomes: [
      "Campaign-ready imagery on demand.",
      "Photography spend cut by 70% or more.",
      "Faster creative testing on paid traffic.",
    ],
    pricing: { from: "R3,500 once-off", note: "Starter, Campaign, and Monthly Retainer packs available." },
  },
};
